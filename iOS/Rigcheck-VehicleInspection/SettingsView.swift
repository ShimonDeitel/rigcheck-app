...
struct SettingsView: View {
    ...
    var body: some View {
        Form {
            ...
            Section("Rigcheck - Vehicle Inspection Pro") {
                if purchases.isPro {
            ...
            Section("About") {
                Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/rigcheck-app/privacy.html")!)
                Link("Terms of Use", destination: URL(string: "https://shimondeitel.github.io/rigcheck-app/terms.html")!)
                Text("Version 1.0")
